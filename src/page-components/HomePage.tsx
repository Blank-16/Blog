                ...
                <div className="md:grid md:grid-cols-[1fr_auto] md:gap-12 md:items-start">
                  ...
                  {(() => {
                    ...
                    <div className="flex items-center gap-3 text-xs text-muted">
                      ...
                      {featured.authorName && featured.$createdAt && <span className="opacity-30">&middot;</span>}
                      {featured.$createdAt && (
                        <span>{formatDate(featured.$createdAt, { month: 'long', day: 'numeric', year: 'numeric' })}</span>
                      )}
                    </div>
                  </div>
